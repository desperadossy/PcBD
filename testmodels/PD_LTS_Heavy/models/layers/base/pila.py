...
pila_cpp = cpp_extension.load(name='pila_cpp', sources=['/root/PcDB/testmodels/PD_LTS_Heavy/models/layers/base/pila.cpp', '/root/PcDB/testmodels/PD_LTS_Heavy/models/layers/base/pila.cu'],
